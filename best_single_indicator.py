"""Script sederhana untuk mencari indikator tunggal terbaik.
Menggunakan data historis dari database dan modul backtesting.
"""
...
def main() -> None:
    ...
    print(result_df)
    if best:
        metric = 'Keuntungan (%)' if 'Keuntungan (%)' in result_df.columns else 'Akurasi'
        print(
